...
String DB_URL = "jdbc:mysql://localhost:3306/librarymsdb";
			...
			connection = DriverManager.getConnection(DB_URL);			statement = connection.createStatement();
			...
			System.out.println(SQLe.toString());
                ...
                Logger.getLogger(PrintingBooks.class.getName()).log(Level.SEVERE, null, ex);
            }
